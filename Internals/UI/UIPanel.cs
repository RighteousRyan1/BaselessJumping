...
namespace BaselessJumping.Internals.UI
{
    public class UIPanel : UIElement
    {
        ...
        {
            SpriteBatch spriteBatch = Base.spriteBatch;
        ...
        public override void Draw()
        {
            ...
            DrawPanel(TextureLoader.GetTexture("UIMid"), BackgroundColor);
            DrawPanel(TextureLoader.GetTexture("UIRing"), BackgroundColor);
        }
    }
}
